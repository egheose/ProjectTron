...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    <div class="content2">
        <asp:Panel ID="SearchPanel" runat="server">
            ...
            <div class="search">
                <dx:ASPxTextBox ID="tbSearch" runat="server" Width="600px"></dx:ASPxTextBox><br />
             <nav>
                    <dx:ASPxButton ID="btnRsearch" runat="server" Text="SEARCH" Width="300px" OnClick="btnRsearch_Click" >
                    </dx:ASPxButton>
             </nav>       
                <asp:LinkButton runat="server" Text="Advanced Search" ID="lnkbtnAdvSearch" OnClick="lnkbtnAdvSearch_Click"></asp:LinkButton>
                </div>
        ...
        <asp:Panel runat="server" ID="advSearchPanel" Visible="false">
            ...
            <div class="search">
                <asp:Table runat="server" BorderStyle="Dotted" BorderWidth="1px" CssClass="search-table">
                    <asp:TableRow>
                        <asp:TableCell>
                             <dx:ASPxTextBox ID="tbSurname" runat="server" Width="200px" NullText="SURNAME"></dx:ASPxTextBox>
                        </asp:TableCell>
                        <asp:TableCell>
                            <dx:ASPxTextBox ID="tbFname" runat="server" Width="200px" NullText="FIRSTNAME"></dx:ASPxTextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
                        <asp:TableCell>
                            <dx:ASPxTextBox ID="tbMname" runat="server" Width="200px" NullText="MIDDLENAME">  </dx:ASPxTextBox>
                        </asp:TableCell>
                        <asp:TableCell>
                            <dx:ASPxTextBox ID="tbPhone" runat="server" Width="200px" NullText="PHONE NUMBER"></dx:ASPxTextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <%--<asp:TableRow>
                        <asp:TableCell>
                    ...
                    <asp:TableRow>
                        <asp:TableCell>
                            <dx:ASPxTextBox ID="tbDOB" runat="server" Width="200px" NullText="DATE OF BIRTH"></dx:ASPxTextBox>
                        </asp:TableCell>
                        <asp:TableCell>
                            <dx:ASPxTextBox ID="tbCompany" runat="server" Width="200px" NullText="COMPANY"></dx:ASPxTextBox>
                        </asp:TableCell>
                    </asp:TableRow>
                    <asp:TableRow>
             ...
             <nav>
                    <dx:ASPxButton ID="btnAdvSearch" runat="server" Text="SEARCH" Width="300px" OnClick="btnAdvSearch_Click" >
                    </dx:ASPxButton>
             </nav>
            ...
            <div class="search-result">
                <br /><br />
                <asp:GridView ID="advResultGrid" PageSize="6" EmptyDataText="No data available." AllowPaging="true" AutoGenerateColumns="true"
                    runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnPageIndexChanging="advResultGrid_PageIndexChanging">
                    <FooterStyle BackColor="White" ForeColor="#000066" />
                    <HeaderStyle BackColor="#006699" Font-Bold="True" ForeColor="White" />
                    <PagerStyle BackColor="White" ForeColor="#000066" HorizontalAlign="Left" />
                    <RowStyle ForeColor="#000066" />
                ...
                <asp:Label ID="lblNF" runat="server" Text=""></asp:Label>                
            </div>
        </asp:Panel>
    </div>
</asp:Content>
